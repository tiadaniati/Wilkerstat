...
st.markdown("""
    ...
    <h2 style='text-align: center; font-size: 50px;'>Kota Bekasi</h2>
""", unsafe_allow_html=True)
st.set_page_config(page_title="Kota Bekasi", page_icon="🌳", layout="wide")
#=========================================================================
...
#===============================
                try:
                    df.to_sql("uploaded_kota_bekasi", con=engine, if_exists=if_exists_option, index=False, dtype={
...
with col1:
    ...
    if table_exists(conn, 'uploaded_kota_bekasi'):
        df_uploaded = pd.read_sql("SELECT * FROM uploaded_kota_bekasi", conn)
    else:
    ...
    m = folium.Map(location=[-6.236055283613221, 106.9699170627418], tiles='OpenStreetMap', zoom_start=13)
...
df_bekasi = pd.read_csv("/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_bekasi.csv")
...
# Baca file CSV
df = pd.read_csv(r"/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_bekasi.csv")
...
df.to_sql("kota_bekasi", con=engine, if_exists="replace", index=False, dtype={
...
cursor.execute("SELECT * FROM kota_bekasi")
