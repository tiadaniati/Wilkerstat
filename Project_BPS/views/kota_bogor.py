...
st.markdown("""
    ...
    <h2 style='text-align: center; font-size: 50px;'>Kota Bogor</h2>
""", unsafe_allow_html=True)
st.set_page_config(page_title="Kota Bogor", page_icon="🌳", layout="wide")
#=========================================================================
...
#===============================
                try:
                    df.to_sql("uploaded_kota_bogor", con=engine, if_exists=if_exists_option, index=False, dtype={
...
with col1:
    ...
    if table_exists(conn, 'uploaded_kota_bogor'):
        df_uploaded = pd.read_sql("SELECT * FROM uploaded_kota_bogor", conn)
    else:
    ...
    m = folium.Map(location=[-6.596891982407816, 106.80390437592699], tiles='OpenStreetMap', zoom_start=13)
...
df_bogor = pd.read_csv("/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_bogor.csv")
...
# Baca file CSV
df = pd.read_csv(r"/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_bogor.csv")
...
df.to_sql("kota_bogor", con=engine, if_exists="replace", index=False, dtype={
...
cursor.execute("SELECT * FROM kota_bogor")
