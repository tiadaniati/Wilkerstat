...
st.markdown("""
    ...
    <h2 style='text-align: center; font-size: 50px;'>Kota Sukabumi</h2>
""", unsafe_allow_html=True)
st.set_page_config(page_title="Kota Sukabumi", page_icon="🌳", layout="wide")
#=========================================================================
...
#===============================
                try:
                    df.to_sql("uploaded_kota_sukabumi", con=engine, if_exists=if_exists_option, index=False, dtype={
...
with col1:
    ...
    if table_exists(conn, 'uploaded_kota_sukabumi'):
        df_uploaded = pd.read_sql("SELECT * FROM uploaded_kota_sukabumi", conn)
    else:
...
df_sukabumi = pd.read_csv("/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_sukabumi.csv")
...
# Baca file CSV
df = pd.read_csv(r"/Users/jibrilnikki/Documents/Code/Project_BPS/dataset/kota_sukabumi.csv")
...
df.to_sql("kota_sukabumi", con=engine, if_exists="replace", index=False, dtype={
...
cursor.execute("SELECT * FROM kota_sukabumi")
