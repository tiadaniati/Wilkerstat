...
with col1:
    ...
    geojson_file = 'Project_BPS/Geolocation/map_kab_ciamis.geojson'
    try:
...
update_rekap_total_landmark(df_merged, "Kabupaten Ciamis", conn_st.engine)
...
with stat1:
    ...
    st.markdown(metric_card("Jumlah SLS", df_ciamis_csv['idsls'].nunique()), unsafe_allow_html=True)
...
with stat2:
    ...
    jumlah_sls = df_ciamis_csv['idsls'].nunique()
